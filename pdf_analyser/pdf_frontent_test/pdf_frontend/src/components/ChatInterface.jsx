...
import { askDocument } from "../services/backendApi";
...
export default function ChatInterface({ docId, docName, selectedPersona }) {
    ...
    const handleSend = async (e) => {
        ...
        try {
            ...
            const answer = await askDocument(docId, input);
            const aiMsg = {
                id: Date.now() + 1,
                role: "ai",
                content: answer || "No response received from the assistant.",
            };
