...
import { FileText, UploadCloud, LayoutDashboard, Settings, Home, Shield } from "lucide-react";
...
export default function Sidebar() {
    ...
    return (
        <motion.aside
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="flex flex-col w-64 h-screen glass-panel transition-all duration-300"
        >
            {/* Logo */}
