...
import { Shield, Lock, Fingerprint, Key, FileText, Download, CheckCircle } from "lucide-react";
    ...
    useEffect(() => {
        ...
        async function loadDocuments() {
            try {
                ...
                if (mounted) setError(err.message || "Failed to load vault documents.");
            } finally {
            ...
            <div className="min-h-screen flex items-center justify-center bg-[linear-gradient(135deg,#0a2463_0%,#020b1f_100%)] p-6">
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-slate-400">Restricted area. Verify your identity to open the vault.</p>
                    </div>
    ...
    return (
        <div className="min-h-screen bg-[#0f1115] p-6 md:p-12 animate-fade-in">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                {/* Secure Grid */}
                {loading && <p className="text-slate-400">Loading vault documents...</p>}
